...
export class CategorieController {
    ...
    @ApiResponse({ status: 404, description: 'Catégorie non trouvée' })
    @ApiResponse({ status: 400, description: 'Pas la bonne requête pour récupérer la catégorie' })
    ...
    @ApiResponse({ status: 404, description: 'Catégorie non trouvée' })
    @ApiResponse({ status: 400, description: 'Pas la bonne requête pour mettre à jour la catégorie' })
    ...
    @ApiResponse({ status: 404, description: 'Catégorie non trouvée' })
    @ApiResponse({ status: 400, description: 'Pas la bonne requête pour supprimer la catégorie' })
